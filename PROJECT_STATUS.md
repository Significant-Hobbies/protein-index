...
- 2026-07-16 — live Amul Protein Water evidence exposed that the adapter ignored Open Food Facts' declared `nutrition_data_per: 100ml` when pack quantity was absent; declared basis and volume evidence now take precedence, and a full 17,732-record replay changes exactly 1,618 volume products from per 100 g to per 100 ml without relabeling the remaining records
