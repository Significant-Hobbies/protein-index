...
export const OFFICIAL_BRAND_SITEMAP_ADAPTER_VERSION = "official-brand-sitemap-v15";
...
export interface OfficialBrandSource { id: string; name: string; allowedHosts: string[]; sitemapUrls: string[]; brandAliases?: string[]; productPathPrefixes?: string[]; requiredNameTerms?: string[]; nutritionImageFilenamePrefixes?: string[]; maxProductPages?: number; maxSitemapDepth?: number; maximumResponseBytes?: number; minimumRequestIntervalMs?: number; maxRetries?: number }
