CREATE TABLE evidence_decisions_v3 (
  id TEXT PRIMARY KEY,
  ...
  decision TEXT NOT NULL CHECK (
    decision IN ('verify', 'reject') OR
    (decision = 'redundant' AND field_family = 'nutrition')
  ),
...
INSERT INTO evidence_decisions_v3 (
...
ALTER TABLE evidence_decisions_v3 RENAME TO evidence_decisions;
